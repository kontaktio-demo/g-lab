...
module.exports = [
  ...
  { key: 'vw', name: 'Volkswagen', models: [
    { name: 'Polo', gens: [G('IV (9N)', 2001, 2009, VAG_ALL), G('V (6R)', 2009, 2017, VAG_ALL), G('VI (AW)', 2017, 2024, VAG_ALL)] },
    { name: 'Golf', gens: [G('IV', 1997, 2003, VAG_ALL), G('V', 2003, 2008, VAG_ALL), G('VI', 2008, 2012, VAG_ALL), G('VII', 2012, 2019, VAG_ALL), G('VIII', 2019, 2025, VAG_ALL)] },
    { name: 'Jetta', gens: [G('V', 2005, 2010, VAG_ALL), G('VI', 2010, 2018, VAG_ALL), G('VII', 2018, 2025, VAG_ALL)] },
    { name: 'Passat', gens: [G('B5', 1996, 2005, VAG_ALL), G('B6', 2005, 2010, VAG_ALL), G('B7', 2010, 2014, VAG_ALL), G('B8', 2014, 2023, VAG_ALL)] },
    { name: 'Arteon', gens: [G('I', 2017, 2024, VAG_ALL)] },
    { name: 'Touran', gens: [G('I', 2003, 2015, VAG_ALL), G('II', 2015, 2024, VAG_ALL)] },
    { name: 'Sharan', gens: [G('II', 2010, 2022, VAG_ALL)] },
    { name: 'Tiguan', gens: [G('I', 2007, 2016, VAG_ALL), G('II', 2016, 2024, VAG_ALL)] },
    { name: 'Touareg', gens: [G('I', 2002, 2010, VAG_ALL), G('II', 2010, 2018, VAG_ALL), G('III', 2018, 2024, VAG_ALL)] },
    { name: 'T5', gens: [G('Transporter T5', 2003, 2015, ['vag_diesel','vag_petrol_turbo'])] },
    { name: 'T6', gens: [G('Transporter T6', 2015, 2024, ['vag_diesel','vag_petrol_turbo'])] },
    { name: 'Caddy', gens: [G('III', 2003, 2015, ['vag_diesel','vag_petrol_na']), G('IV', 2015, 2020, ['vag_diesel','vag_petrol_turbo']), G('V', 2020, 2024, ['vag_diesel','vag_petrol_turbo'])] },
    { name: 'Crafter', gens: [G('I', 2006, 2017, ['vag_diesel']), G('II', 2017, 2024, ['vag_diesel'])] },
    { name: 'Up!', gens: [G('I', 2011, 2023, ['vag_petrol_na'])] },
    { name: 'Scirocco', gens: [G('III', 2008, 2017, VAG_ALL)] },
  ]},
  { key: 'audi', name: 'Audi', models: [
    { name: 'A1', gens: [G('I (8X)', 2010, 2018, VAG_ALL), G('II (GB)', 2018, 2024, VAG_ALL)] },
    { name: 'A3', gens: [G('8L', 1996, 2003, VAG_ALL), G('8P', 2003, 2012, VAG_ALL), G('8V', 2012, 2020, VAG_ALL), G('8Y', 2020, 2024, VAG_ALL)] },
    { name: 'A4', gens: [G('B5', 1995, 2001, VAG_ALL), G('B6', 2001, 2005, VAG_ALL), G('B7', 2005, 2008, VAG_ALL), G('B8', 2008, 2015, VAG_ALL), G('B9', 2015, 2024, VAG_ALL)] },
    { name: 'A5', gens: [G('I (8T)', 2007, 2016, VAG_ALL), G('II (F5)', 2016, 2024, VAG_ALL)] },
    ...
    { name: 'Q2', gens: [G('I', 2016, 2024, VAG_ALL)] },
    { name: 'Q3', gens: [G('I (8U)', 2011, 2018, VAG_ALL), G('II (F3)', 2018, 2024, VAG_ALL)] },
    { name: 'Q5', gens: [G('I (8R)', 2008, 2017, VAG_ALL), G('II (FY)', 2017, 2024, VAG_ALL)] },
    { name: 'Q7', gens: [G('I (4L)', 2005, 2015, VAG_ALL), G('II (4M)', 2015, 2024, VAG_ALL)] },
    { name: 'Q8', gens: [G('I (4M)', 2018, 2024, VAG_ALL)] },
    { name: 'TT', gens: [G('II (8J)', 2006, 2014, VAG_ALL), G('III (8S)', 2014, 2023, VAG_ALL)] },
  ]},
  { key: 'skoda', name: 'Skoda', models: [
    { name: 'Fabia', gens: [G('I', 1999, 2007, VAG_ALL), G('II', 2007, 2014, VAG_ALL), G('III', 2014, 2021, VAG_ALL), G('IV', 2021, 2024, VAG_ALL)] },
    { name: 'Rapid', gens: [G('I', 2012, 2019, VAG_ALL)] },
    { name: 'Scala', gens: [G('I', 2019, 2024, VAG_ALL)] },
    { name: 'Octavia', gens: [G('I', 1996, 2010, VAG_ALL), G('II', 2004, 2013, VAG_ALL), G('III', 2013, 2020, VAG_ALL), G('IV', 2020, 2024, VAG_ALL)] },
    { name: 'Superb', gens: [G('I', 2001, 2008, VAG_ALL), G('II', 2008, 2015, VAG_ALL), G('III', 2015, 2024, VAG_ALL)] },
    { name: 'Yeti', gens: [G('I', 2009, 2017, VAG_ALL)] },
    { name: 'Karoq', gens: [G('I', 2017, 2024, VAG_ALL)] },
    { name: 'Kodiaq', gens: [G('I', 2016, 2024, VAG_ALL)] },
    { name: 'Roomster', gens: [G('I', 2006, 2015, VAG_ALL)] },
    { name: 'Kamiq', gens: [G('I', 2019, 2024, VAG_ALL)] },
  ]},
  { key: 'seat', name: 'Seat', models: [
    { name: 'Ibiza', gens: [G('III (6L)', 2002, 2008, VAG_ALL), G('IV (6J)', 2008, 2017, VAG_ALL), G('V (KJ)', 2017, 2024, VAG_ALL)] },
    { name: 'Leon', gens: [G('I (1M)', 1999, 2006, VAG_ALL), G('II (1P)', 2005, 2012, VAG_ALL), G('III (5F)', 2012, 2020, VAG_ALL), G('IV (KL)', 2020, 2024, VAG_ALL)] },
    { name: 'Toledo', gens: [G('III (5P)', 2004, 2009, VAG_ALL), G('IV (KG)', 2012, 2019, VAG_ALL)] },
    { name: 'Altea', gens: [G('I', 2004, 2015, VAG_ALL)] },
    { name: 'Ateca', gens: [G('I', 2016, 2024, VAG_ALL)] },
    { name: 'Arona', gens: [G('I', 2017, 2024, VAG_ALL)] },
    { name: 'Tarraco', gens: [G('I', 2018, 2024, VAG_ALL)] },
    { name: 'Alhambra', gens: [G('II', 2010, 2020, VAG_ALL)] },
  ]},
  ...
  { key: 'bmw', name: 'BMW', models: [
    { name: 'Seria 1', gens: [G('E87', 2004, 2011, BMW_ALL), G('F20/F21', 2011, 2019, BMW_ALL), G('F40', 2019, 2024, BMW_ALL)] },
    { name: 'Seria 2', gens: [G('F22/F23', 2014, 2021, BMW_ALL), G('G42', 2021, 2024, BMW_ALL)] },
    { name: 'Seria 3', gens: [G('E46', 1998, 2005, BMW_ALL), G('E90/E91/E92/E93', 2005, 2013, BMW_ALL), G('F30/F31/F34', 2011, 2019, BMW_ALL), G('G20/G21', 2018, 2024, BMW_ALL)] },
    { name: 'Seria 4', gens: [G('F32/F33/F36', 2013, 2020, BMW_ALL), G('G22/G23/G26', 2020, 2024, BMW_ALL)] },
    { name: 'Seria 5', gens: [G('E39', 1995, 2004, BMW_ALL), G('E60/E61', 2003, 2010, BMW_ALL), G('F10/F11/F07', 2009, 2017, BMW_ALL), G('G30/G31', 2017, 2023, BMW_ALL), G('G60', 2023, 2024, BMW_ALL)] },
    { name: 'Seria 6', gens: [G('E63/E64', 2003, 2010, BMW_ALL), G('F12/F13/F06', 2011, 2018, BMW_ALL), G('G32 GT', 2017, 2024, BMW_ALL)] },
    { name: 'Seria 7', gens: [G('E65/E66', 2001, 2008, BMW_ALL), G('F01/F02', 2008, 2015, BMW_ALL), G('G11/G12', 2015, 2022, BMW_ALL), G('G70', 2022, 2024, BMW_ALL)] },
    { name: 'X1', gens: [G('E84', 2009, 2015, BMW_ALL), G('F48', 2015, 2022, BMW_ALL), G('U11', 2022, 2024, BMW_ALL)] },
    { name: 'X2', gens: [G('F39', 2018, 2023, BMW_ALL)] },
    { name: 'X3', gens: [G('E83', 2003, 2010, BMW_ALL), G('F25', 2010, 2017, BMW_ALL), G('G01', 2017, 2024, BMW_ALL)] },
    { name: 'X4', gens: [G('F26', 2014, 2018, BMW_ALL), G('G02', 2018, 2024, BMW_ALL)] },
    { name: 'X5', gens: [G('E70', 2006, 2013, BMW_ALL), G('F15', 2013, 2018, BMW_ALL), G('G05', 2018, 2024, BMW_ALL)] },
    { name: 'X6', gens: [G('E71', 2008, 2014, BMW_ALL), G('F16', 2014, 2019, BMW_ALL), G('G06', 2019, 2024, BMW_ALL)] },
    { name: 'X7', gens: [G('G07', 2018, 2024, BMW_ALL)] },
    { name: 'Z4', gens: [G('E89', 2009, 2016, BMW_ALL), G('G29', 2018, 2024, BMW_ALL)] },
  ]},
  ...
  { key: 'mercedes', name: 'Mercedes-Benz', models: [
    { name: 'Klasa A', gens: [G('W169', 2004, 2012, MB_ALL), G('W176', 2012, 2018, MB_ALL), G('W177', 2018, 2024, MB_ALL)] },
    { name: 'Klasa B', gens: [G('W245', 2005, 2011, MB_ALL), G('W246', 2011, 2018, MB_ALL), G('W247', 2018, 2024, MB_ALL)] },
    { name: 'CLA', gens: [G('C117', 2013, 2019, MB_ALL), G('C118', 2019, 2024, MB_ALL)] },
    { name: 'GLA', gens: [G('X156', 2014, 2020, MB_ALL), G('H247', 2020, 2024, MB_ALL)] },
    { name: 'Klasa C', gens: [G('W203', 2000, 2007, MB_ALL), G('W204', 2007, 2014, MB_ALL), G('W205', 2014, 2021, MB_ALL), G('W206', 2021, 2024, MB_ALL)] },
    { name: 'CLK', gens: [G('W209', 2002, 2010, MB_ALL)] },
    { name: 'CLS', gens: [G('W219', 2004, 2010, MB_ALL), G('W218', 2010, 2018, MB_ALL), G('W257', 2018, 2024, MB_ALL)] },
    { name: 'Klasa E', gens: [G('W211', 2002, 2009, MB_ALL), G('W212', 2009, 2016, MB_ALL), G('W213', 2016, 2023, MB_ALL), G('W214', 2023, 2024, MB_ALL)] },
    { name: 'Klasa S', gens: [G('W221', 2005, 2013, MB_ALL), G('W222', 2013, 2020, MB_ALL), G('W223', 2020, 2024, MB_ALL)] },
    { name: 'GLB', gens: [G('X247', 2019, 2024, MB_ALL)] },
    { name: 'GLC', gens: [G('X253', 2015, 2022, MB_ALL), G('X254', 2022, 2024, MB_ALL)] },
    { name: 'GLE', gens: [G('W166', 2015, 2018, MB_ALL), G('V167', 2018, 2024, MB_ALL)] },
    { name: 'GLS', gens: [G('X166', 2015, 2019, MB_ALL), G('X167', 2019, 2024, MB_ALL)] },
    { name: 'ML', gens: [G('W164', 2005, 2011, MB_ALL), G('W166', 2011, 2015, MB_ALL)] },
    { name: 'GL', gens: [G('X164', 2006, 2012, MB_ALL), G('X166', 2012, 2015, MB_ALL)] },
    { name: 'Vito', gens: [G('W639', 2003, 2014, ['mb_diesel']), G('W447', 2014, 2024, ['mb_diesel'])] },
    { name: 'Sprinter', gens: [G('NCV3 (W906)', 2006, 2018, ['mb_diesel']), G('VS30 (W907)', 2018, 2024, ['mb_diesel'])] },
  ]},
