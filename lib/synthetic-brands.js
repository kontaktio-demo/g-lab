...
module.exports = [
  ...
  { key: 'mercedes', name: 'Mercedes-Benz', models: [
    { name: 'Klasa A', silnikRe: /^(A\s|AMG A)/, gens: [G('W169', 2004, 2012, MB_ALL), G('W176', 2012, 2018, MB_ALL), G('W177', 2018, 2024, MB_ALL)] },
    { name: 'Klasa B', silnikRe: /^B\s/, gens: [G('W245', 2005, 2011, MB_ALL), G('W246', 2011, 2018, MB_ALL), G('W247', 2018, 2024, MB_ALL)] },
    { name: 'CLA', silnikRe: /^CLA\s/, gens: [G('C117', 2013, 2019, MB_ALL), G('C118', 2019, 2024, MB_ALL)] },
    { name: 'GLA', silnikRe: /^GLA\s/, gens: [G('X156', 2014, 2020, MB_ALL), G('H247', 2020, 2024, MB_ALL)] },
    { name: 'Klasa C', silnikRe: /^(C\s|AMG C)/, gens: [G('W203', 2000, 2007, MB_ALL), G('W204', 2007, 2014, MB_ALL), G('W205', 2014, 2021, MB_ALL), G('W206', 2021, 2024, MB_ALL)] },
    { name: 'CLK', silnikRe: /^CLK\s/, gens: [G('W209', 2002, 2010, MB_ALL)] },
    { name: 'CLS', silnikRe: /^CLS\s/, gens: [G('W219', 2004, 2010, MB_ALL), G('W218', 2010, 2018, MB_ALL), G('W257', 2018, 2024, MB_ALL)] },
    { name: 'Klasa E', silnikRe: /^(E\s|AMG E)/, gens: [G('W211', 2002, 2009, MB_ALL), G('W212', 2009, 2016, MB_ALL), G('W213', 2016, 2023, MB_ALL), G('W214', 2023, 2024, MB_ALL)] },
    { name: 'Klasa S', silnikRe: /^S\s/, gens: [G('W221', 2005, 2013, MB_ALL), G('W222', 2013, 2020, MB_ALL), G('W223', 2020, 2024, MB_ALL)] },
    { name: 'GLB', silnikRe: /^GLB\s/, gens: [G('X247', 2019, 2024, MB_ALL)] },
    { name: 'GLC', silnikRe: /^GLC\s/, gens: [G('X253', 2015, 2022, MB_ALL), G('X254', 2022, 2024, MB_ALL)] },
    { name: 'GLE', silnikRe: /^GLE\s/, gens: [G('W166', 2015, 2018, MB_ALL), G('V167', 2018, 2024, MB_ALL)] },
    { name: 'GLS', silnikRe: /^GLS\s/, gens: [G('X166', 2015, 2019, MB_ALL), G('X167', 2019, 2024, MB_ALL)] },
    { name: 'ML', silnikRe: /^ML\s/, gens: [G('W164', 2005, 2011, MB_ALL), G('W166', 2011, 2015, MB_ALL)] },
    { name: 'GL', silnikRe: /^GL\s/, gens: [G('X164', 2006, 2012, MB_ALL), G('X166', 2012, 2015, MB_ALL)] },
